...
export function updateReadmeWithTranslations(
  ...
  // 检查是否已有多语言翻译部分
  const existingSectionRegex = /## 🌐 Translations?[^\n]*[\s\S]*?(?=^## |$)/m
  ...
  // 在多语言翻译部分添加到 README 开头（在第一个标题之后）
